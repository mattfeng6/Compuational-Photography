...
blur = 80;     % width of crossfade, CHOOSE WISELY
...
blur = 18;     % width of crossfade, CHOOSE WISELY
...
blur = 25;     % width of crossfade, CHOOSE WISELY
...
function im_feather = feather_blend(im_bg, im_s, mask_s, blur)
    ...
    filter_blur = fspecial('average', blur);
    mask_blurred = imfilter(mask_s, filter_blur);
    im_feather = im_s .* mask_blurred + im_bg .* (1-mask_blurred);
